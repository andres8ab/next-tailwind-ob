    ...
    <div className="dark:border-gray-700 font-sans">
      ...
      <div className="flex min-h-screen flex-col justify-between">
        <header className="fixed left-0 top-0 w-full z-10 ease-in duration-300">
          <nav className="flex h-14 items-center px-4 justify-between shadow-lg bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
            ...
            <Link href="/cart" className="p-2 flex">
              ...
              {cartItemsCount > 0 && (
                <span className="ml-1 rounded-full bg-red-600 p-1 text-xs font-bold text-white w-5 h-5 flex items-center justify-center">
                  {cartItemsCount}
                </span>
              )}
            </Link>
